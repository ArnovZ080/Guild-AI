    ...
    >
      ...
      {data.naturalLanguageDescription ? (
        <div className="mb-2">
          ...
          <button
            onClick={() => {
              setNlInput(data.naturalLanguageDescription || '');
              setIsConfiguring(true);
            }}
            className="w-full mt-2 text-xs p-2 border border-blue-300 rounded bg-blue-50 text-blue-700 hover:bg-blue-100 transition-colors"
          >
            Edit Configuration
          </button>
        </div>
  ...
  useEffect(() => {
    async function fetchActivatedAgents() {
      ...
      const defaultIncluded = [
        // Judge Layer
        { id: 'judge_agent', name: 'Judge Agent', included_in_subscription: true },
        { id: 'agent_evaluator', name: 'Agent Evaluator', included_in_subscription: true },
        // Orchestration Layer
        { id: 'orchestrator_agent', name: 'Orchestrator Agent', included_in_subscription: true },
        { id: 'automation_agent', name: 'Automation Agent', included_in_subscription: true },
        { id: 'connector_agent', name: 'Connector Agent', included_in_subscription: true },
        // Business Intelligence Layer
        { id: 'business_intelligence_agent', name: 'Business Intelligence Agent', included_in_subscription: true },
        { id: 'financial_intelligence_agent', name: 'Financial Intelligence Agent', included_in_subscription: true },
        { id: 'customer_intelligence_agent', name: 'Customer Intelligence Agent', included_in_subscription: true },
        // Execution Layer
        { id: 'content_intelligence_agent', name: 'Content Intelligence Agent', included_in_subscription: true },
        { id: 'automation_bridge_agent', name: 'Automation Bridge Agent', included_in_subscription: true },
        // Operations Layer
        { id: 'onboarding_agent', name: 'Onboarding Agent', included_in_subscription: true },
        { id: 'calendar_harmony_agent', name: 'Calendar Harmony Agent', included_in_subscription: true },
        // Optional
        { id: 'security_agent', name: 'Security Agent', included_in_subscription: true },
        { id: 'wellbeing_agent', name: 'Wellbeing / Workload Agent', included_in_subscription: true },
        // Additional Agents
        { id: 'research_agent', name: 'Research Agent', included_in_subscription: false, daily_rate_usd: 1.50, monthly_rate_usd: 12 },
        { id: 'marketing_agent', name: 'Marketing Agent', included_in_subscription: false, daily_rate_usd: 1.50, monthly_rate_usd: 12 },
        { id: 'sales_agent', name: 'Sales Agent', included_in_subscription: false, daily_rate_usd: 1.50, monthly_rate_usd: 12 },
        { id: 'content_agent', name: 'Content Agent', included_in_subscription: false, daily_rate_usd: 1.50, monthly_rate_usd: 12 },
        { id: 'social_media_agent', name: 'Social Media Agent', included_in_subscription: false, daily_rate_usd: 1.50, monthly_rate_usd: 12 },
        { id: 'writer_agent', name: 'Writer Agent', included_in_subscription: false, daily_rate_usd: 1.50, monthly_rate_usd: 12 },
        { id: 'analytics_agent', name: 'Analytics Agent', included_in_subscription: false, daily_rate_usd: 1.50, monthly_rate_usd: 12 },
        { id: 'pricing_agent', name: 'Pricing Agent', included_in_subscription: false, daily_rate_usd: 1.50, monthly_rate_usd: 12 },
        { id: 'hr_agent', name: 'HR Agent', included_in_subscription: false, daily_rate_usd: 1.50, monthly_rate_usd: 12 },
        { id: 'training_agent', name: 'Training Agent', included_in_subscription: false, daily_rate_usd: 1.50, monthly_rate_usd: 12 },
        { id: 'crm_agent', name: 'CRM Agent', included_in_subscription: false, daily_rate_usd: 1.50, monthly_rate_usd: 12 },
        { id: 'outbound_sales_agent', name: 'Outbound Sales Agent', included_in_subscription: false, daily_rate_usd: 1.50, monthly_rate_usd: 12 },
        { id: 'project_manager_agent', name: 'Project Manager Agent', included_in_subscription: false, daily_rate_usd: 1.50, monthly_rate_usd: 12 },
        { id: 'learning_agent', name: 'Learning Agent', included_in_subscription: false, daily_rate_usd: 1.50, monthly_rate_usd: 12 },
        { id: 'community_connector_agent', name: 'Community Connector Agent', included_in_subscription: false, daily_rate_usd: 1.50, monthly_rate_usd: 12 },
        { id: 'celebration_narrator_agent', name: 'Celebration Narrator Agent', included_in_subscription: false, daily_rate_usd: 1.50, monthly_rate_usd: 12 },
      ];

      try {
        if (!API) { 
          setAvailableAgents(defaultIncluded); 
          return; 
        }
        ...
        if (!res.ok) { 
          console.warn('API agents/available failed, using default agents');
          setAvailableAgents(defaultIncluded); 
          return; 
        }
        ...
        const mapped = entitled.map((a: any) => ({ 
          id: a.agent_id || a.id, 
          name: a.name, 
          daily_rate_usd: a.daily_rate_usd, 
          monthly_rate_usd: a.monthly_rate_usd, 
          included_in_subscription: Boolean(a.included_in_subscription), 
          hired_until: a.hired_until || null 
        }));
        ...
        console.warn('Failed to fetch agents, using default agents:', error);
        setAvailableAgents(defaultIncluded);
      }
    }
