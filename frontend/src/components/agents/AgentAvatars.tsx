...
export const agentPersonalities = {
  ...
  'research': {
    ...
    description: 'Deep research and data analysis'
  },
  'marketing': {
    name: 'Marketing Agent',
    avatar: '🎨',
    icon: TrendingUp,
    personality: 'Creative, strategic, growth-focused',
    colors: {
      primary: 'from-green-600 to-emerald-800',
      secondary: 'bg-green-100 dark:bg-green-900',
      text: 'text-green-700 dark:text-green-300'
    },
    traits: ['Creative', 'Strategic', 'Growth-focused'],
  ...
  'sales': {
    ...
    traits: ['Persuasive', 'Relationship-focused', 'Results-driven'],
  ...
  'content': {
    ...
    colors: {
      primary: 'from-red-600 to-pink-800',
