  ...
  const questions = [
    {
      ...
      allowCustom: true,
      reassurance: "Your brand voice is how you sound to your audience. If you're unsure, we can help you discover it through your existing content and audience feedback."
    },
    {
      ...
      allowCustom: true,
      reassurance: "Brand personality helps your audience connect with you emotionally. You can always refine this as your brand evolves."
    },
    {
      id: 'brand_colors',
      ...
      allowCustom: true,
      reassurance: "Brand colors create visual consistency. If you don't have them yet, our Brand Strategist can help you choose colors that align with your brand personality and industry."
    },
    {
      id: 'logo_status',
      ...
      allowCustom: true,
      reassurance: "A strong logo builds brand recognition. If you need help creating or improving yours, our Design Agent can assist with logo concepts and iterations."
    },
    {
      id: 'brand_visual_style',
      text: "How would you describe your brand's visual style?",
      subtext: "This includes imagery, design elements, and overall aesthetic that represents your brand.",
      options: [
      ...
      allowCustom: true,
      reassurance: "Visual style consistency helps build brand recognition. We can help you develop a cohesive visual identity across all your materials."
    },
    {
      id: 'brand_values',
      text: "What core values drive your brand?",
      subtext: "These are the principles that guide your business decisions and how you interact with customers.",
      options: [
      ...
      allowCustom: true,
      supportText: "Think about what principles are most important to you and your business. These values should guide all your decisions and communications.",
      reassurance: "Brand values help you make consistent decisions and attract customers who share similar beliefs. This creates deeper, more meaningful connections."
    },
    {
      id: 'brand_story',
      text: "Do you have a clear brand story or origin story?",
      subtext: "Your brand story explains why you started your business and what makes you unique.",
      options: [
      ...
      allowCustom: true,
      reassurance: "Every business has a unique story worth telling. Our Storytelling Agent can help you craft a compelling narrative that connects with your audience and differentiates your brand."
    },
    {
      id: 'brand_positioning',
      text: "How do you want to be positioned in your market?",
      subtext: "Brand positioning is how you want to be perceived relative to your competitors.",
      options: [
      ...
      allowCustom: true,
      reassurance: "Clear positioning helps customers understand why they should choose you over competitors. We can help you find your unique position in the market."
    },
    {
      id: 'brand_differentiation',
      text: "What makes your brand unique or different?",
      subtext: "This is your competitive advantage - what sets you apart from others in your space.",
      allowCustom: true,
      supportText: "Think about what you do differently, better, or uniquely compared to your competitors. This could be your process, your approach, your expertise, or your personality.",
      reassurance: "Understanding your unique value proposition is crucial for effective marketing. If you're unsure, our Strategy Agent can help you identify and articulate what makes you special."
    },
    {
      id: 'brand_consistency',
      text: "How consistent is your current brand across different touchpoints?",
      subtext: "This includes your website, social media, email, marketing materials, and customer communications.",
      options: [
      ...
      allowCustom: true,
      reassurance: "Brand consistency builds trust and recognition. If you need help creating brand guidelines, our Brand Strategist can develop comprehensive guidelines for all your communications."
    }
  ];
