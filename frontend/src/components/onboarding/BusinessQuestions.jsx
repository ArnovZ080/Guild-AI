...
const BusinessQuestions = ({ onNext, onBack, userProfile, updateUserProfile }) => {
  return (
    <div className="text-center">
      <h2 className="text-2xl font-bold mb-4">Business Questions</h2>
      <p className="mb-8">Tell us about your business</p>
