...
// InsightsModal replaced by GoalInsightsModal import above
...
const GoalsDashboard = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <GoalInsightsModal goal={selectedGoal} insights={insights} isOpen={showInsightsModal} onClose={() => setShowInsightsModal(false)} />
    </div>
  );
};
