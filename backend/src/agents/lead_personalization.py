"""
Enhanced Personalization Agent - Production Ready for Google Cloud Vertex AI
...
class LeadPersonalizationAgent(AgentTemplate):
    """
    Enhanced Personalization Agent with full BaseAgent integration
    Production-ready for Google Cloud Vertex AI deployment
    """
    
    def __init__(self, agent_id: str = "lead_personalization"):
        ...
        super().__init__(
            ...
            description="Lead Personalization Agent for Guild-AI",
            capabilities=[
                "strategic_planning",
