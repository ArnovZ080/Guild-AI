...
class JudgeAgent(AgentTemplate):
    """
    Enhanced Judge Agent with full BaseAgent integration
    Production-ready for Google Cloud Vertex AI deployment
    """
    
    def __init__(self, agent_id: str = "judge"):
        ...
        super().__init__(
            agent_id=agent_id,
            name="Judge Agent",
            description="Comprehensive quality evaluation and rubric management using advanced prompting strategies.",
            capabilities=[
                "strategic_planning",
            "data_analysis"
            ],
