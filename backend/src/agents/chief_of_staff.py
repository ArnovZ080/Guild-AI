"""
Enhanced Staff Agent - Production Ready for Google Cloud Vertex AI
...
class ChiefOfStaffAgent(AgentTemplate):
    """
    Enhanced Staff Agent with full BaseAgent integration
    Production-ready for Google Cloud Vertex AI deployment
    """
    
    def __init__(self, agent_id: str = "chief_of_staff"):
        ...
        super().__init__(
            agent_id=agent_id,
            name="Staff Agent",
            description="Chief of Staff Agent for Guild-AI",
            capabilities=[
