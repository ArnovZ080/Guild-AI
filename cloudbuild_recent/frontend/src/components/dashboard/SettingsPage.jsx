    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      {isAdmin && (
        <>
          ...
          <Section title="Agent Knowledge Library">
            <div className="text-sm text-gray-500 mb-4">
              Manage the private knowledge base that powers your AI agents. Upload business strategies, mentor content, and proprietary methods.
            </div>
