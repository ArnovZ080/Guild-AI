    ...
    def __init__(self):
        self.servers = {
            ...
            "social_media": MCPServer(
                name="social_media",
                url="https://guild-ai.com/mcp/social-media",
                label="social_media",
                allowed_tools=[
            ...
            "crm": MCPServer(
                name="crm",
                url="https://guild-ai.com/mcp/crm",
                label="crm",
                allowed_tools=[
                    "create_lead",
                    "send_email_sequence",
            ...
            "accounting": MCPServer(
                name="accounting",
                url="https://guild-ai.com/mcp/accounting",
                label="accounting",
                allowed_tools=[
                    "create_invoice",
                    "record_expense",
            ...
            "calendar": MCPServer(
                name="calendar",
                url="https://guild-ai.com/mcp/calendar",
                label="calendar",
                allowed_tools=[
                    "create_event",
                    "schedule_meeting",
            ...
            "ecommerce": MCPServer(
                name="ecommerce",
                url="https://guild-ai.com/mcp/ecommerce",
                label="ecommerce",
                allowed_tools=[
                    "create_product",
                    "update_inventory",
            ...
            "analytics": MCPServer(
                name="analytics",
                url="https://guild-ai.com/mcp/analytics",
                label="analytics",
                allowed_tools=[
            ...
            "project_management": MCPServer(
                ...
                url="https://guild-ai.com/mcp/project-management",
            ...
            "payments": MCPServer(
                name="payments",
                url="https://guild-ai.com/mcp/payments",
                label="payments",
                allowed_tools=[
                    "create_payment_link",
                    "process_refund",
            ...
            "communication": MCPServer(
                name="communication",
                url="https://guild-ai.com/mcp/communication",
                label="communication",
                allowed_tools=[
                    "send_message",
                    "create_meeting",
            ...
            "email_marketing": MCPServer(
                ...
                url="https://guild-ai.com/mcp/email-marketing",
            ...
            "ad_platforms": MCPServer(
                name="ad_platforms",
                url="https://guild-ai.com/mcp/ad-platforms",
                label="ad_platforms",
                allowed_tools=[
            ...
            "support": MCPServer(
                name="support",
                url="https://guild-ai.com/mcp/support",
                label="support",
                allowed_tools=[
            ...
            "cloud_infrastructure": MCPServer(
                ...
                url="https://guild-ai.com/mcp/cloud-infrastructure",
            ...
            "ai_analytics": MCPServer(
                name="ai_analytics",
                url="https://guild-ai.com/mcp/ai-analytics",
                label="ai_analytics",
                allowed_tools=[
                    "generate_ai_content",
            ...
            "human_os": MCPServer(
                name="human_os",
                url="https://guild-ai.com/mcp/human-os",
                label="human_os",
                allowed_tools=[
                    "track_wellness_goal",
            ...
            "design_media": MCPServer(
                name="design_media",
                url="https://guild-ai.com/mcp/design-media",
                label="design_media",
                allowed_tools=[
                    "generate_ai_image",
                    "create_logo_design",
            ...
            "intelligence": MCPServer(
                name="intelligence",
                url="https://guild-ai.com/mcp/intelligence",
                label="intelligence",
                allowed_tools=[
            ...
            "recruitment": MCPServer(
                name="recruitment",
                url="https://guild-ai.com/mcp/recruitment",
                label="recruitment",
                allowed_tools=[
                    "create_job_posting",
                    "source_candidates",
            ...
            "seo_tools": MCPServer(
                name="seo_tools",
                url="https://guild-ai.com/mcp/seo-tools",
                label="seo_tools",
                allowed_tools=[
                    "analyze_website_seo",
            ...
            "productivity": MCPServer(
                name="productivity",
                url="https://guild-ai.com/mcp/productivity",
                label="productivity",
                allowed_tools=[
                    "create_task",
                    "schedule_meeting",
