"""
Enhanced Content Agent - Production Ready for Google Cloud Vertex AI
...
class ContentStrategistAgent(AgentTemplate):
    """
    Enhanced Content Agent with full BaseAgent integration
    Production-ready for Google Cloud Vertex AI deployment
    """
    ...
    def __init__(self, agent_id: str = "content_strategist"):
        ...
        specific_capabilities = [
            AgentCapability(
                ...
                description="Content Creation management and optimization",
                complexity=TaskComplexity.MODERATE,
                estimated_duration=15
            ),
            AgentCapability(
                name="content_optimization",
                description="Content Optimization management and optimization",
                complexity=TaskComplexity.MODERATE,
                estimated_duration=15
            ),
            AgentCapability(
                name="creative_strategy",
                description="Creative Strategy management and optimization",
                complexity=TaskComplexity.MODERATE,
                estimated_duration=15
            ),
            AgentCapability(
        ...
        super().__init__(
            agent_id=agent_id,
            name="Content Agent",
            description="Generates a comprehensive, data-driven content strategy and calendar using advanced prompting strategies.",
            capabilities=[
                "content_creation",
