...
class AffiliatePartnershipsAgent(AgentTemplate):
    """
    Enhanced Partnerships Agent with full BaseAgent integration
    Production-ready for Google Cloud Vertex AI deployment
    """
    
    def __init__(self, agent_id: str = "affiliate_partnerships"):
        ...
        super().__init__(
            ...
            description="Affiliate & Partnerships Agent for Guild-AI",
            capabilities=[
