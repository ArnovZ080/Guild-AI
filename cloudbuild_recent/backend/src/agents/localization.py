"""
Enhanced Localization Agent - Production Ready for Google Cloud Vertex AI
...
class LocalizationAgent(AgentTemplate):
    """
    Enhanced Localization Agent with full BaseAgent integration
    Production-ready for Google Cloud Vertex AI deployment
    """
    
    def __init__(self, agent_id: str = "localization"):
        ...
        super().__init__(
            ...
            description="Comprehensive content localization using advanced prompting strategies.",
            capabilities=[
